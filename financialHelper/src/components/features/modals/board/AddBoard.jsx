    ...
    return (
        <Modal open={open}>
            <form className='modal__form' onSubmit={handleSubmit(submitHandler)}>
                ...
                <input {...register('description', {required: requiredMessage})} className={errors.balance ? 'modal__input modal__error' : 'modal__input'} placeholder='Описание' type='text' maxLength={512}/>
